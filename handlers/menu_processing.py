...
async def main_menu(session, level, menu_name):
    ...
    keybrds = get_user_main_btns(level=level)

    return image, keybrds
...
async def catalog(session, level, menu_name):
    ...
    keybrds = get_user_catalog_btns(level=level, categories=categories)
